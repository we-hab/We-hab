    ...
    public static void initialiseButtons(Button dashboard, Button workout, Button medication, Button settings, Button signOut) {
        ...
        if (workout != null) {
            workout.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    try {
                        MainApplication.switchScene("/edu/qut/cab302/wehab/fxml/workout/Visual-Progress-Tracking.fxml");
                    } catch (IOException e) {
        ...
        if (settings != null) {
            settings.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    try {
                        MainApplication.switchScene("/edu/qut/cab302/wehab/fxml/settings/settings-page.fxml");
                    } catch (IOException e) {
